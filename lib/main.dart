...
import 'package:flutter_app_rsa_provider/base/ui/message_dialog.dart';
import 'package:flutter_app_rsa_provider/ui/test_viewimpl.dart';
...
class _MyHomePageState extends State<MyHomePage> implements TestViewImpl {
  int _counter = 0;

  void _incrementCounter() {
    TestPresenter testPresenter = new TestPresenter();
    testPresenter.attachView(this);
    testPresenter.fetchUsers();
    setState(() {
  ...
  void _showConfirmDialog() {
    MessageDialog.builder(context)
        ...
        .addActionButton("Cancel", () => Navigator.pop(context))
        .addActionButton("Ok", () {
          _incrementCounter();
  ...
  void onLoadListUserFail(Exception e) {
    // TODO: implement onLoadListUserFail
  }

  @override
  void onLoadListUserSuccess( List<User> data) {
    data.forEach((user) => print(user.name));
  }
